...
Private Sub querys()
    ...
    a = " SELECT  b.agent as ""Agent Saat Ini"", a.custid as ""Customer ID"" , b.name as ""Customer Name"","
    a = a & " date(a.tgl) as ""Action Date"",to_char(a.tgl,'HH24:MI:SS') AS ""Action Time"",  d.tblstatuscall_kdstscall as ""Action Code"",b.delq_history as ""DPD"", b.cmbbaseon as ""Contact Mode"","
    ...
    a = a & " coalesce(b.curbal::numeric,0)-coalesce(""Paid Amount""::numeric,0) end  ""Balance Update"",b.nocard ""Card Number"" ,b.curbal as ""Outstanding"",c.promisepay as ""PTP Volume"","
...
Set M_objrs = New ADODB.Recordset
    ...
    While Not M_objrs.EOF
        ...
        '===asep==='
        cbocampaign.AddItem IIf(IsNull(M_objrs!recsource), "", M_objrs!recsource)
        '======'
        M_objrs.MoveNext
    Wend
Set M_objrs = Nothing
...
Public Sub load_spv()
    ...
    ElseIf MDIForm1.txtlevel.text = "Supervisor" Then
        ...
        '==asep==='
        'sStrsql = "select distinct recsource from mgm where agent in (select userid from usertbl where team = '" & MDIForm1.txtusername.text & "' or userid = '" & MDIForm1.txtusername.text & "' )) order by   kodeds"
        '========='
    Else
...
'    End If
 ...
 Set objExcel = CreateObject("Excel.Application")
    ...
    '===asep=='
    'Set objBook = objExcel.Worksheet.ADD
    '========='
...
'    lblstatus.Caption = "Status download: Mengisi field... silahkan tunggu!"
   ...
   ' lblstatus.Caption = "Status download: Membuat file excel... silahkan tunggu!"
    ...
    '===asep===='
    'objBook.SaveAs TxtPath.text, xlWorksheetNormal
    '==========='
